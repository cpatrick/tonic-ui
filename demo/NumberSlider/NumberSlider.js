...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    NumberSliderControl = __webpack_require__(158),
	    component = null;
	...
	var ColorField = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'section',
	      null,
	      React.createElement(NumberSliderControl, { value: r, max: '255', min: '0', onChange: this.updateVal, name: 'r' }),
	      React.createElement(NumberSliderControl, { value: g, max: '255', min: '0', onChange: this.updateVal, name: 'g' }),
	      React.createElement(NumberSliderControl, { value: b, max: '255', min: '0', onChange: this.updateVal, name: 'b' }),
	      React.createElement('canvas', { ref: 'canvas', width: '50', height: '50' })
	    );
	  }
	});

	component = ReactDOM.render(React.createElement(ColorField, null), document.querySelector('.content'));
