...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonSelector = __webpack_require__(159);
	...
	_reactDom2.default.render(_react2.default.createElement(_ButtonSelector2.default, { list: [{ name: "Choice A" }, { name: "Choice B" }, { name: "Choice C" }], onChange: process }), container);
	  ...
	  render: function render() {
	    ...
	    this.props.list.forEach(function (item) {
	      list.push(_react2.default.createElement(
	        'button',
	        { key: item.name, name: item.name, onClick: _this.processItem },
	        item.name
	      ));
	    });
