...
import GeometryRenderer  from '../../renderer/Geometry';
import ImageRenderer     from '../../renderer/Image';
import MultiViewRenderer from '../../renderer/MultiLayout';
...
export default React.createClass({
    ...
    propTypes: {
        ...
        renderers: React.PropTypes.array,
    },
                    ...
                    <div className='CatalystWidget_control_bar'>
                        <i
                            className={ magicLensController ? 
                                            ( magicLensController.isFront() ? 'fa fa-search left' : 'fa-inverse fa fa-search left') 
                                            : 'is-hidden' }
                        ...
                        <i
                            className={ (serverRecording && isImageRenderer && this.props.imageBuilder.handleRecord) 
                                ? (this.state.record ? 'fa fa-circle left': 'fa fa-circle-thin left') : 'is-hidden' }
