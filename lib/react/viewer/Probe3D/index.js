...
var React = require('react'),
    ...
    QueryDataModelWidget = require('../../widget/ParameterSet/QueryDataModelWidget'),
    LookupTableManagerWidget = require('../../widget/LookupTable/LookupTableManagerWidget'),
    ProbeControl = require('../../widget/ProbeControl'),
    CollapsibleElement = require('../../widget/CollapsibleElement'),
    CatalystWidget = require('../AbstractMenu'),
    ChartViewer = require('../LineChart'),
    renderAxisMap = {
        'XY': [0,1,2],
        'ZY': [2,1,0],
        'XZ': [0,2,1]
