...
var React = require('react'),
    ...
    swatchURL = require('./defaultSwatches.png');
    ...
    return (
      <div className='ColorPicker'>
        <div className='ColorPicker__color'>
          ...
          <input type='number' min='0' max='255' value={ this.state.color[0] } data-color-idx='0' onChange={ this.rgbColorChange } />
          <input type='number' min='0' max='255' value={ this.state.color[1] } data-color-idx='1' onChange={ this.rgbColorChange } />
          <input type='number' min='0' max='255' value={ this.state.color[2] } data-color-idx='2' onChange={ this.rgbColorChange } />
        </div>
        <div className='ColorPicker__swatch'>
          <img ref='swatch' width="100%" src={ this.state.swatch } onClick={ this.showColor } onMouseMove={ this.showColor } onMouseLeave={ this.showColor } />
        </div>
      </div>
    );
  }
